...
opp_2012.to_csv(ROOT + 'opp_2012_clean.csv')
opp_2013.to_csv(ROOT + 'opp_2013_clean.csv')
opp_2014.to_csv(ROOT + 'opp_2014_clean.csv')
opp_2015.to_csv(ROOT + 'opp_2015_clean.csv')
